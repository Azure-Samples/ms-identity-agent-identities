...
$blueprint1 = New-AgentIdentityBlueprint -DisplayName "Agent Identity Blueprint Example $blueprintNumber" `
...
$secret1 = Add-ClientSecretToAgentIdentityBlueprint 
...
if ($hasInteractiveAgents) {
    ...
    $interactiveScope = Add-ScopeToAgentIdentityBlueprint
...
if ($hasInheritablePermissions) {
    ...
    $inheritablePerms = Add-InheritablePermissionsToAgentIdentityBlueprint -Scopes @("user.read", "mail.read", "calendars.read")
...
if ($hasAgentIDUsers) {
    ...
    $redirectUri = Add-RedirectURIToAgentIdentityBlueprint 
...
$principal1 = New-AgentIdentityBlueprintPrincipal 
...
while ($continueCreating) {
    ...
    $agentIdentity = New-AgentIDForAgentIdentityBlueprint -DisplayName "Agent Identity Example $agentCounter" `
        -SponsorUserIds @("7c2f8f10-cba8-4a8d-9449-db4b76d1ef80")
    ...
    if ($hasAgentIDUsers) {
        ...
        if ($agentIDNeedsUser) {
            ...
            $agentUser = New-AgentIDUserForAgentId -DisplayName "Agent User Example $agentCounter" `
                -UserPrincipalName "AgentUser$agentCounter@67lxx6.onmicrosoft.com"
...
Get-Command -Module EntraAgentID | Format-Table Name, CommandType -AutoSize
